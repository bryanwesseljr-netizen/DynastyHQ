...
import { ExternalLink, Loader2, Sparkles, WandSparkles } from 'lucide-react';
...
const CustomNewsroomPhotoCreator = ({ mediaLibrary = [], defaultFolder = NEWSROOM_MEDIA_FOLDERS.COLLEGE }) => {
  ...
  return (
    <div className="mt-4 rounded-xl border border-violet-500/25 bg-violet-950/10 p-4">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-[10px] leading-relaxed text-slate-400">Write your own image prompt here and DynastyHQ will generate the photo, upload it, and file it automatically. Approved AI references from the same career folder are used when available.</p>
        </div>
