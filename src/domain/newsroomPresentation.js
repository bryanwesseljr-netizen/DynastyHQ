...
const PRESENTATIONS = Object.freeze({
  broadsheet: {
    ...
    strapline: 'The official record of the season',
    accent: '#b7791f',
    accentStrong: '#8a570c',
    masthead: '#13202d',
    paper: '#f8f5ed',
    ...
    muted: '#66717c',
    rule: '#d8d1c3',
    sectionHeadings: ['The week in focus', 'What it means from here'],
    sidebarTitle: 'Season notebook',
  },
  local: {
    layout: 'community',
    category: 'Metro Detroit Sports',
    strapline: 'Local football. Local stakes.',
    accent: '#c8202f',
    accentStrong: '#9d1622',
    masthead: '#102235',
    paper: '#fbfbfa',
    ...
    muted: '#66707c',
    rule: '#d6dbe0',
    sectionHeadings: ['The story behind the week', 'The road ahead'],
    sidebarTitle: 'Local storylines',
  },
  on3: {
    layout: 'insider',
    category: 'Recruiting & Evaluation',
    strapline: 'Intel, movement and the decision ahead',
    accent: '#f4b940',
    accentStrong: '#d89212',
    masthead: '#0b0c0f',
    paper: '#f5f3ee',
    ...
    muted: '#66676d',
    rule: '#d9d4c9',
    sectionHeadings: ['Inside the recruitment', 'What evaluators watch next'],
    sidebarTitle: 'Recruiting intel',
  },
  filmroom: {
    layout: 'analysis',
    category: 'Film & Performance',
    strapline: 'The numbers behind the next step',
    accent: '#2dd4bf',
    accentStrong: '#0f9f8f',
    masthead: '#071827',
    paper: '#eef4f4',
    ...
    muted: '#607079',
    rule: '#cbd8d8',
    sectionHeadings: ['What the performance shows', 'The next evaluation'],
    sidebarTitle: 'Analyst notebook',
  },
  national: {
    layout: 'network',
    category: 'National College Football',
    strapline: 'The bigger picture of the journey',
    accent: '#ef3340',
    accentStrong: '#bd1825',
    masthead: '#111722',
    paper: '#ffffff',
    ...
    muted: '#68717e',
    rule: '#dfe3e8',
    sectionHeadings: ['Why this week matters', 'Where the story goes next'],
    sidebarTitle: 'National perspective',
  },
  network: {
    layout: 'network',
    category: 'National College Football',
    ...
    muted: '#686f79',
    rule: '#dfe2e6',
    sectionHeadings: ['Why this week matters', 'The national view'],
    sidebarTitle: 'National perspective',
  },
  regional: {
    layout: 'regional',
    category: 'Regional College Football',
    strapline: 'Programs, players and the race around the region',
    accent: '#9f2432',
    accentStrong: '#791824',
    masthead: '#30141b',
    paper: '#faf6ef',
    ...
    muted: '#746568',
    rule: '#ddcfd0',
    sectionHeadings: ['Across the region', 'The stakes ahead'],
    sidebarTitle: 'Regional watch',
  },
});
...
export const buildEditorialExtras = ({ story = {}, issue = {} }) => {
  ...
  const generatedHeadings = (Array.isArray(story.sectionHeadings) ? story.sectionHeadings : [])
    ...
    .filter(Boolean)
    .slice(0, 3);
  const sectionHeadings = generatedHeadings.length >= 2
    ? generatedHeadings
  ...
  return { sectionHeadings, pullQuote, sidebars };
};
