...
const handleSaveGameClick = () => {
          ...
          <div id="mobile-primary-navigation" className="border-t border-slate-800 bg-[#071019] px-4 py-4 shadow-2xl min-[1100px]:hidden">
            ...
            {!isReadOnly && (
              <div className="mx-auto mt-3 flex max-w-5xl flex-wrap items-center gap-2 border-t border-slate-800 pt-3">
                ...
                <button type="button" onClick={() => handlePublishToPublic()} className="ml-auto flex items-center gap-2 rounded border border-slate-700 bg-slate-900 px-3 py-2 text-[9px] font-black uppercase tracking-wider text-white"><Share2 size={13} /> Get Share Link</button>
              </div>
            )}
          </div>
        )}
  ...
  return (
    <div className="h-screen overflow-hidden bg-slate-950 font-sans text-slate-200 selection:bg-amber-500/30">
       {/* Top navigation */}
       {renderNav()}
