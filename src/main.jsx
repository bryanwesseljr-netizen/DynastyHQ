...
import EditorialComparisonPage from './components/EditorialComparisonPage.jsx'
...
const editorialCompare = new URLSearchParams(window.location.search).get('editorialCompare') === '1'
