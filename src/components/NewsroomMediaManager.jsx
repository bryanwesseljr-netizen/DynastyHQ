      ...
      {libraryOpen && (
        <div className="mt-4 rounded-xl border border-slate-700 bg-slate-900 p-4">
          <div className="mb-3 flex items-center justify-between">
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-300">Choose an uploaded image</p>
      ...
      {lockerOpen && (
        <div className="mt-4 rounded-xl border border-amber-500/20 bg-amber-950/10 p-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              <p className="text-[10px] font-black uppercase tracking-[0.18em] text-amber-300">Approved Reference Locker</p>
              <p className="mt-1 text-[10px] text-slate-500">Mark the clearest face, home/away uniform, helmet, and equipment references. The first four approved images are used.</p>
            </div>
          ...
          ) : <p className="mt-4 rounded-lg border border-dashed border-slate-700 p-5 text-center text-xs text-slate-500">Upload your first article photo or approved reference.</p>}
